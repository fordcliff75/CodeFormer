        ...
        for idx, cropped_face in enumerate(face_helper.cropped_faces):
            ...
            try:
                with torch.no_grad():
                    ...
                    # ⚡ Bolt: use tensor2img_fast to perform GPU-bound post-processing before PCIe transfer
                    restored_face = tensor2img_fast(output, rgb2bgr=True, min_max=(-1, 1))
                del output
                # ⚡ Bolt: removed torch.cuda.empty_cache() to avoid global GPU sync and memory thrashing
