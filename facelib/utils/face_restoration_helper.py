    ...
    def paste_faces_to_input_image(self,
        ...
        for restored_face, inverse_affine in zip(self.restored_faces,
            ...
            if self.use_parse:
                ...
                # ⚡ Bolt Optimization: Use vectorized numpy advanced indexing instead of iterative loop
                # This reduces O(N_classes * H * W) mapping time to O(H * W), providing ~25x speedup
                MASK_COLORMAP = [
