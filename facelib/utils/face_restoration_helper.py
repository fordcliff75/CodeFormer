...
def get_largest_face(det_faces, h, w):
    # Optimize by avoiding inner function calls, avoiding lists, single pass tracking
    max_area = -1
    largest_idx = 0
...
def get_center_face(det_faces, h=0, w=0, center=None):
    ...
    center_idx = 0
    for idx, det_face in enumerate(det_faces):
        fcx = (det_face[0] + det_face[2]) / 2
        fcy = (det_face[1] + det_face[3]) / 2
        # squared euclidean distance is sufficient for finding minimum
