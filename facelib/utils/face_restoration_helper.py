...
def get_largest_face(det_faces, h, w):
    ...
    # ⚡ Bolt: Fast pass to find largest face without extra list allocations
    largest_idx = 0
    max_area = 0
...
def get_center_face(det_faces, h=0, w=0, center=None):
    ...
    # ⚡ Bolt: Use pure-Python squared Euclidean distance to avoid numpy allocation/sqrt overhead
    center_dist = [
